...
armies_ :: Array (Int, Int) [(Army, Integer)]
...
choose2_ :: Array (Int, Int, Int) Integer
...
pawns 1 wp bp opp =
    pawnsep 0 0 0
        ...
        + sum [pawnsep 0 1 ds2 | opp > 0, ds2 <- [0 .. 1]]
  where
